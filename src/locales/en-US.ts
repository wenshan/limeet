export default {
  ...
  'brand.page.story.list02': 'We truly appreciate the chance to share our products with you and your furry companions. At Limeet, we’re all about crafting more pet-friendly designs—ones that blend top-notch eco-friendly materials with fine craftsmanship, seamlessly fitting into your home life. In our design approach, we keep things user-friendly while staying true to that natural, eco-conscious vibe. ',
