export default {
  ...
  'brand.page.story.list01': 'Limeet Pet Home creates the perfect fusion of pets and home, and is a bridge connecting you and your pet.',
  'brand.page.story.list02': 'Mr. Zhang believes that stimulating the natural vitality and health of people and pets can bring wonderful experiences and exchanges, and allow us to stay together longer.',
  'brand.page.story.list03': 'In 1999, the founder, Mr. Zhang, was studying in Norway. One Christmas night, he learned from his landlord that dogs and cats also had their own rooms and play areas. Since then, he has been connected with the dog and cat pet home.',
  'brand.page.story.list04': 'In 2003, Zhang returned to China with great enthusiasm and soon began to research the domestic pet food market, set up a research and development team, and share his experiences in Northern Europe.',
  'brand.page.story.list05': 'In 2007, he hoped to build a natural bridge between human and pet homes, connect the emotions between pets and their owners, and create a perfect home for people and pets. Finally, he established the "Limeet" company as he wished.',
