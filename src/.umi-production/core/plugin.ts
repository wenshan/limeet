...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_2,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/hou/work/limeet/src/.umi-production/plugin-dva/runtime.tsx',
    },
    {
      apply: Plugin_3,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/hou/work/limeet/src/.umi-production/plugin-initialState/runtime.tsx',
    },
    {
      apply: Plugin_4,
